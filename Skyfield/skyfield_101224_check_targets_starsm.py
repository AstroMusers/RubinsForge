...
for i in range(0,8):
    ...
    plt.tight_layout()
    plt.savefig(directoryp +  "/" + c.strftime('%H%M') + "/Target_positions_for_" +str(t00.astimezone(zone)) + str(i) + "_radec_A.png")
    plt.close()
    t00 = t00 + deltatime
...
for i in range(0,8):
    ...
    plt.title(f'Target positions for {t00.astimezone(zone)} in Alt-Az')
    plt.grid()
    ax.xaxis.set_major_formatter(FuncFormatter(ra_formatter))
    ...
    plt.tight_layout()
    plt.savefig(directoryp +  "/" + c.strftime('%H%M') + "/Target_positions_for_" +str(t00.astimezone(zone)) + str(i) + "_altaz_B.png")
    plt.close()
    t00 = t00 + deltatime
...
for i in range(0,8):
    ...
    ax.set_ylabel('Dec (degrees)')    
    plt.tight_layout()
    plt.savefig(directoryp +  "/" + c.strftime('%H%M') + "/Target_positions_for_" +str(t00.astimezone(zone)) + '_' + str(timestep) +  "_radec_C.png")
    plt.close()
    ...
    plt.savefig(directoryp +  "/" + c.strftime('%H%M') + "/Separation_target_histogram_for_" + str(t00.astimezone(zone))+ '_' +  str(timestep) + "_D.png")
