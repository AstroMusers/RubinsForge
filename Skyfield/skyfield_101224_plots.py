...
sat_alt = []
sat_height = []
with fits.open('/data/a.saricaoglu/Lumos-Sat/Files/01.25/1742_satellite_data.fits') as hdul:
    hdul.info()
...
np.savetxt(directoryf +  "/" + str(c.strftime('%H%M')) +"/totaltrail_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) + ".txt", a1)

# os.makedirs(directoryf +  "/" + str(c.strftime('%H%M')) +"/totalvalid_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) + ".txt")
np.savetxt(directoryf +  "/" + str(c.strftime('%H%M')) +"/totalvalid_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) + ".txt", a2)

# os.makedirs(directoryf +  "/" + str(c.strftime('%H%M')) +"/totalcontamination_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) +  ".txt")
np.savetxt(directoryf +  "/" + str(c.strftime('%H%M')) +"/totalcontamination_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) +  ".txt", a3)

# os.makedirs(directoryf +  "/" + str(c.strftime('%H%M')) +"/totalevent_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) +  ".txt")
np.savetxt(directoryf +  "/" + str(c.strftime('%H%M')) +"/totalevent_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) +  ".txt", a4)

# os.makedirs(directoryf +  "/" + str(c.strftime('%H%M')) +"/totalclosestapproach_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) + ".txt")
np.savetxt(directoryf +  "/" + str(c.strftime('%H%M')) +"/totalclosestapproach_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) + ".txt", a5)
#np.savetxt(directoryf + "/totaltrailti_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) + "_" + c.strftime('%H%M') + ".txt", a6)
...
np.savetxt(directoryf +  "/" + str(c.strftime('%H%M')) +"/totalpeakmag_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) + "_" + c.strftime('%H%M') + ".txt", aa1)

np.savetxt(directoryf  +  "/" + str(c.strftime('%H%M')) +"/totalaveragemag_logfile_for_" + str(utc_dt.day) + str(utc_dt.month) + "_" + str(utc_dt.year) + "_" + c.strftime('%H%M') + ".txt", aa2)
